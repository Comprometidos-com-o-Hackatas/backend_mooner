    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('premium', models.CharField(blank=True, choices=[('Eclipse', 'Eclipse'), ('Lua Nova', 'Lua Nova'), ('Apollo 8', 'Apollo 8'), ('Ano Lunar', 'Ano Lunar'), ('Apollo 11', 'Apollo 11')], default=None, max_length=50, null=True)),
